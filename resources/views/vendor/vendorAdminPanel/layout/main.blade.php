        ...
        <div class="row">
            ...
            <div class="col-lg-2 col-md-4 sidebar">
                ...
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-dark" href="{{ route('productCategories', ['id' => $vendor->id]) }}"><i
                                class="fas fa-list me-2"></i>Product Categories</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-dark" href="{{ route('productVariations', ['id' => $vendor->id]) }}"><i
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-dark" href="{{ route('orderDetails', ['id' => $vendor->id]) }}"><i
                                class="fas fa-clipboard-check me-2"></i>Orders
                            Details</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-dark" href="{{ route('orderHistory', ['id' => $vendor->id]) }}"><i
                                class="fas fa-history me-2"></i>Orders
                            History</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-dark" href="{{ route('vendorCustomers', ['id' => $vendor->id]) }}"><i
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-dark" href="{{ route('paymentHistory', ['id' => $vendor->id]) }}"><i
