  ...
  <div class="container py-3">
    ...
    <div class="d-flex row">
      ...
      <div class="d-flex align-items-center col-md-4 mb-4">
        ...
        <a href="{{ route('removePaymentMethod',['id' => $method->id ])}}" class="text-decoration-none text-danger"><i
        ...
        <div class="col-md-12">
          ...
          <div class="row">
            ...
            <div class="col-md-4 mb-4">
              ...
              <input type="text" class="form-control" id="number" placeholder="Ali Nasir" value="{{!empty($bankDetails) ? $bankDetails->account_name : ''}}" name="accountName">
            </div>
            <div class="col-md-4 mb-4">
              <label for="number" class="form-label">Bank account number:</label>
              <input type="text" class="form-control" id="number" placeholder="730099999996" value="{{!empty($bankDetails) ? $bankDetails->account_number : ''}}" name="accountNumber">
            </div>
            <div class="col-md-4 mb-4">
              <label for="number" class="form-label">Bank Name:</label>
              <input type="text" class="form-control" id="number" placeholder="Mezan Bank" value="{{!empty($bankDetails) ? $bankDetails->bank_name : ''}}" name="bankName">
            </div>
            <div class="col-md-4 mb-4">
              <label for="number" class="form-label">Branch Name:</label>
              <input type="text" class="form-control" id="number" placeholder="Main Branch" value="{{!empty($bankDetails) ? $bankDetails->branch_name : ''}}" name="branchName">
            </div>
            <div class="col-md-4 mb-4">
              <label for="number" class="form-label">Bank Identification Code(BIC) or Swift Code:</label>
              <input type="text" class="form-control" id="number" placeholder="ABCDEFGHXXX" value="{{!empty($bankDetails) ? $bankDetails->bic : ''}}" name="bic">
            </div>
            <div class="col-md-4 mb-4">
              <label for="number" class="form-label">International Bank Account Number(IBAN):</label>
              <input type="text" class="form-control" id="number" placeholder="PK12ABCD1234567890123456" value="{{!empty($bankDetails) ? $bankDetails->iban : ''}}" name="iban">
            </div>
            <div class="col-md-4 mb-4">
              <label for="number" class="form-label">Bank Address</label>
              <input type="text" class="form-control" id="number" placeholder="123 Main Street, City, Country" value="{{!empty($bankDetails) ? $bankDetails->bank_address : ''}}" name="bankAddress">
            </div>
