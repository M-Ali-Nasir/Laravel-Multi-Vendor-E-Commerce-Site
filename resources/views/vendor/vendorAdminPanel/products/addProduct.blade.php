...
@section('mainBody')
    ...
    @elseif (count($categories) == 0)
        <div class="text-center py-5 my-5">
            <i class="far fa-sad-tear" style="font-size: 5rem;"></i>
            <p class="lead">Oops! You don't have any category for products. You need to first create atleast one category
                to add Products on your store.</p>
            <a href="{{ route('productCategories', ['id' => $vendor->id]) }}" class="btn btn-primary">Add
                Categories</a>
        </div>
    @elseif (count($variations) == 0)
        <div class="text-center py-5 my-5">
            <i class="far fa-sad-tear" style="font-size: 5rem;"></i>
            <p class="lead">Oops! You don't have created any variation for products. You need to first create at least one
                variation to add Products on your store.</p>
            <a href="{{ route('productVariations', ['id' => $vendor->id]) }}" class="btn btn-primary">Add
                Variations</a>
        </div>
    @else
        <!-- Create Product Form -->
        ...
        <form class="px-5 py-5" action="{{ route('addProduct', ['id' => $store->id]) }}" method="post"
            ...
            <button type="submit" class="btn btn-outline-success mx-2">Add Product</button>
        </form>
