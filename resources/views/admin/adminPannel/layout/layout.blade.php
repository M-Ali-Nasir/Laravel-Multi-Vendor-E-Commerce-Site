    ...
    <div class="content" id="main-content">
        ...
        <nav class="navbar navbar-dark bg-dark rounded-bottom-5 shadow">
            <div class="container-fluid">
                <a class="navbar-brand" href="{{ route('admin.dashboard', ['id' => $admin->id]) }}">
                    <img src="{{ asset('images/home/logo.png') }}" alt="Vendor" width="30" height="30"
            ...
            <div class="row">
                ...
                <div class="col-lg-2 col-md-4 sidebar mt-2 rounded-end-5">
                    ...
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item rounded-4 {{ request()->routeIs('admin.dashboard') ? 'bg-dark' : '' }}">
                            <a class="nav-link {{ request()->routeIs('admin.dashboard') ? 'text-light' : 'text-dark' }}"
                                href="{{ route('admin.dashboard', ['id' => $admin->id]) }}"><i
                                    class="fas fa-globe me-2"></i>Dashboard</a>
                        </li>
                        ...
                        <li class="nav-item rounded-4 {{ request()->routeIs('admin.customers') ? 'bg-dark' : '' }}">
                            <a class="nav-link {{ request()->routeIs('admin.customers') ? 'text-light' : 'text-dark' }}"
                                href="{{ route('admin.customers', ['id' => $admin->id]) }}"><i
                                    class="fas fa-user-cog me-2"></i>All Customers</a>
                        </li>
                        <li class="nav-item rounded-4 {{ request()->routeIs('admin.vendors') ? 'bg-dark' : '' }}">
                            <a class="nav-link {{ request()->routeIs('admin.vendors') ? 'text-light' : 'text-dark' }}"
                                href="{{ route('admin.vendors', ['id' => $admin->id]) }}"><i
                                    class="fas fa-user-cog me-2"></i>All Vendors</a>
                        </li>
