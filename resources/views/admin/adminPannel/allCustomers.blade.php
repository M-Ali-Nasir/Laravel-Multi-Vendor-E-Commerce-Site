                                            ...
                                            <div class="modal-body text-center">
                                                @if ($customer->status == 'active')
                                                    <a class="btn btn-warning me-3"
                                                        href="{{ route('admin.inactiveCustomer', ['customer_id' => $customer->id]) }}">Inactive
                                                        User</a>
                                                    <a class="btn btn-danger ms-3"
                                                        href="{{ route('admin.banCustomer', ['customer_id' => $customer->id]) }}">Ban
                                                        User</a>
                                                @elseif ($customer->status == 'inactive')
                                                    <a class="btn btn-success me-3"
                                                        href="{{ route('admin.activeCustomer', ['customer_id' => $customer->id]) }}">Active
                                                        User</a>
                                                    <a class="btn btn-danger ms-3"
                                                        href="{{ route('admin.banCustomer', ['customer_id' => $customer->id]) }}">Ban
                                                        User</a>
