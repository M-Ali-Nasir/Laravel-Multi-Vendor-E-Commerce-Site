                ...
                <div class="col-12 col-sm-6">
                  <div class="mb-4 mb-sm-0">
                    ...
                    <div>
                      ...
                      <p class="mb-0">
                        <a class="link-secondary text-decoration-none" href="tel:{{ $store->phone }}">{{ $store->phone }}</a>
                      </p>
                    </div>
                  </div>
                </div>
                <div class="col-12 col-sm-6">
                  <div class="mb-4 mb-sm-0">
                    ...
                    <div>
                      ...
                      <hr class="w-75 mb-3 border-dark-subtle">
                      <p class="mb-0">
                        <a class="link-secondary text-decoration-none" href="mailto:{{ $vendor->email }}">{{ $vendor->email }}</a>
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div>
                ...
                <div>
                  ...
                  <div class="d-flex mb-1">
                    <p class="text-secondary fw-bold mb-0 me-5">{{ $store['opening-day'] }} - {{ $store['closing-day'] }}</p>
                    <p class="text-secondary mb-0">{{ date('h:i a', strtotime($store['opening-time'])) }} - {{ date('h:i a', strtotime($store['closing-time'])) }}</p>
                  </div>
